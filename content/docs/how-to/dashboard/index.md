...
```bash
docker run -it -p 3000:3000 -e WAHA_DASHBOARD_USERNAME=waha -e WAHA_DASHBOARD_PASSWORD=waha devlikeapro/waha
```
...
Session keys also support **granular scopes** that restrict what actions the key can perform:

<p align="center">
  <img src="waha-dashboard-api-key-permissions.png" alt="API Keys Permissions">
</p>

Read more about available scopes in [**🔒 Session Key Scopes**]({{< relref "/docs/how-to/security#session-key-scopes" >}}).
