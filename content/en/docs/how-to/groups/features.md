...
| `GET /api/{session}/groups/{id}/settings/security/info-admin-only`     |  ✔️   |       |  ✔️  |
| `PUT /api/{session}/groups/{id}/settings/security/info-admin-only`     |  ✔️   |       |  ✔️  |
| `GET /api/{session}/groups/{id}/settings/security/messages-admin-only` |  ✔️   |       |  ✔️  |
| `PUT /api/{session}/groups/{id}/settings/security/messages-admin-only` |  ✔️   |       |  ✔️  |
